...
public class KafkaTopicConfig {
    ...
    /**
     * Creates the topic used to publish payment-response event.
     *
     * <p>This topic is part of the payment workflow and is consumed by
     * the order-service.</p>
     */
    @Bean
    public NewTopic paymentResponseV1Topic(KafkaTopicProperties props) {
        return TopicBuilder.name(EventConstants.TOPIC_ORDER_PAYMENT_RESPONSE_V1)
     ...
     */
    @Bean
    public NewTopic paymentDltTopic(KafkaTopicProperties props) {
